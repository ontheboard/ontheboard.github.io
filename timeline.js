...
function add_timeline() {
    ...
    let data=[
        ...
        [
            ...
            "1843, in the second of two matches, Staunton develops heart palpitations, which interfere with his playing of chess, he nevertheless wins the match with eleven wins, four draws, and six losses; the heart palpitations continue for the rest of his life [and affect his playing]",
            "1844, Howard Staunton catches pneumonia whilst travelling to Europe, in the hopes of playing Von der Lasa",
            "1849, Nathaniel Cooke, a journalist and editor of the 'Illustrated London News' designs a chess set which is then manufactured by Jacques of London; this chess set is promoted in Staunton's chess column in the 'Illustrated London News' and the first 500 sets are numbered and signed by Howard Staunton - this design of chess set becomes known as the Staunton chess set, which is the standard design of chess set today",
            ...
            "1858, Staunton, with work committments, fails to find time to get back into form, and after rough treatment in the press, finally cancels a match against Morphy [although much more has been said about this, this is all there really is to say about it - there's a wikipedia page if you can be bothered to read about the 'controversy' but please remember that there was already heavy hostile bias against Staunton in 1858, because of George Walker, and afterwards because of Morphy's assistant Frederick Edge, and this bias has biased later writers]",
